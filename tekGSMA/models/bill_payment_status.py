...
class BillPaymentStatus(object):
    ...
    def __init__(self):  # noqa: E501
        """BillPaymentStatus - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BillPaymentStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BillPaymentStatus):
            return False
