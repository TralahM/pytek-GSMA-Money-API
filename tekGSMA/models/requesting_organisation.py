...
class RequestingOrganisation(object):
    ...
    def __init__(self):  # noqa: E501
        """RequestingOrganisation - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RequestingOrganisation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RequestingOrganisation):
            return False
