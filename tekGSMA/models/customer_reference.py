...
class CustomerReference(object):
    ...
    def __init__(self):  # noqa: E501
        """CustomerReference - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CustomerReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CustomerReference):
            return False
